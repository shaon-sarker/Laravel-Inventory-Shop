                                 ...
                                 <table class="table">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                        ...
                                        <td class="text-center">{{ $item['customer']['name'] ?? 'N/A' }}</td>
                                        <td class="text-center">#{{ $item['invoice']['invoice_no'] ?? 'N/A' }}</td>
                                        ...
                                        @php
                                            // Check if $item->due_amount is set before adding it to $total_due
